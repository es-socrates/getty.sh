...
Si estás familiarizado con GitHub, [clona el repositorio](https://github.com/gettyteam/getty) usando cualquier herramienta git que prefieras. **Opción B:** descarga el ZIP y extráelo en tu PC.
